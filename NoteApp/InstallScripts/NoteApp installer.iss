...
#define MyAppPublisher "Aleksei Kovkin"
#define MyAppExeName "NoteAppUI.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{43F14324-996D-46ED-9FDF-66239220FBFF}
AppName={#MyAppName}
...
Source: "..\NoteAppUI\bin\Release\*.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\NoteAppUI\bin\Release\*.ico"; DestDir: "{app}"; Flags: ignoreversion
